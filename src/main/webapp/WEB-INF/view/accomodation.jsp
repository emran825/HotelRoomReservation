<%-- 
    ...
    Created on : Jun 10, 2019, 12:38:26 PM
    Author     : B2
--%>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="${pageContext.request.contextPath}/about">About us</a></li>
							...
							<li class="nav-item"><a class="btn theme_btn button_hover login" href="#">Login</a></li>
                        </ul>
                    </div> 
                </nav>
            </div>
