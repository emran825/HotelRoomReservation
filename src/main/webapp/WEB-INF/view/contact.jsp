<%-- 
    Document   : contact
    Created on : Jul 13, 2019, 6:57:35 PM
    Author     : SARK
--%>
        ...
        <header class="header_area">
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <a class="navbar-brand logo_h" href="index.html"><img src="resources/image/Logo.png" alt=""></a>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
       ...
       <!--================Contact Success and Error message Area =================-->
        ...
        <!--gmaps Js-->
        <script src="resources/jqueryUI/map.js" type="text/javascript"></script>
