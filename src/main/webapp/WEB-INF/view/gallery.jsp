<%-- 
    Document   : gallery
    Created on : Jul 13, 2019, 6:23:52 PM
    Author     : SARK
--%>
                            ...
                            <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/contact">Contact</a></li>
                             <li class="nav-item submenu dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/login">Customer Login</a></li>
                                </ul>
                            </li> 
                ...
                <div class="row imageGallery1" id="gallery">
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="resources/image/gallery/01.jpg" alt="">
                            <div class="hover">
                            	<a class="light" href="resources/image/gallery/01.jpg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="resources/image/gallery/02.jpg" alt="">
                            <div class="hover">
                            	<a class="light" href="resources/image/gallery/02.jpg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="resources/image/gallery/03.jpg" alt="">
                            <div class="hover">
                            	<a class="light" href="resources/image/gallery/03.jpg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="resources/image/gallery/04.jpg" alt="">
                            <div class="hover">
                            	<a class="light" href="resources/image/gallery/04.jpg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="resources/image/gallery/06.jpg" alt="">
                            <div class="hover">
                            	<a class="light" href="resources/image/gallery/05.jpg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="resources/image/gallery/05.jpg" alt="">
                            <div class="hover">
                            	<a class="light" href="resources/image/gallery/06.jpg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="resources/image/gallery/01-1.jpg" alt="">
                            <div class="hover">
                            	<a class="light" href="resources/image/gallery/01-1.jpg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="resources/image/gallery/02-1.jpg" alt="">
                            <div class="hover">
                            	<a class="light" href="resources/image/gallery/02-1.jpg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="resources/image/gallery/03-1.jpg" alt="">
                            <div class="hover">
                            	<a class="light" href="resources/image/gallery/03-1.jpg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
