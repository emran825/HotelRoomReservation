                    ...
                    <div class="panel-body">
                        <div class="formcontainer">
                            <c:if test="${check}">
                                ...
                                <form:form name="addCategoryObject" modelAttribute="addCategoryObject1" action="addingroomtype" method="post">
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            <form:input class="form-control" Placeholder="Room Type Id" type="text" path="roomtypeid" required="true" id="catid"></form:input>
                                                <label for="catid">Room Type Id</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-label-group">
                                            <form:input class="form-control" Placeholder="Room Type" type="text" path="roomtype" required="true" id="catname"></form:input>
                                                <label for="catname">Room Type</label>
                                            </div>
                                        </div>
                            ...
                            <c:if test="${!check}">
                                <form:form name="addCategoryObject" modelAttribute="addCategoryObject1" action="addingroomtype" method="post">
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            <form:input class="form-control" Placeholder="Room Type Id" type="text" path="roomtypeid" required="true" id="catid" readonly="true"></form:input>
                                                <label for="catid">Room Type Id</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
...
<!--                                    <td>{{Cat.facilitycost}}</td>-->
                                    <td>
                                        <a href="editroomtypebutton?getcid={{Cat.roomtypeid}}"><button id="editbuttons" type="submit" class="btn">Edit</button></a> <a href="removeroomtype/{{Cat.roomtypeid}}"><button  id="removebuttons" type="button" class="btn btn-danger">Remove</button></a>
